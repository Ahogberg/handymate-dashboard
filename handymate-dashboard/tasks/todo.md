...
- [ ] A. Företagsskanningen (components/tour/CompanyScan.tsx + API):
...
- [ ] B. Daniels agentrad på offertsidan (app/dashboard/quotes/[id]):
...
- [ ] C. Spec efter lansering: Field Command (mobilappen, punkt 1 i
