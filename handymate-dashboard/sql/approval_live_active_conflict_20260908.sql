-- Authorized conflict test: only this synthetic booking, while its review is open.
UPDATE booking b
...
AND b.assigned_user_id='bu_rollprov_owner' AND b.assigned_to='Rollprov Ägare'
AND cfg.business_id=b.business_id AND cfg.business_name='TEST Rollprov A'
AND m.business_id=b.business_id AND m.id='bu_rollprov_admin'
