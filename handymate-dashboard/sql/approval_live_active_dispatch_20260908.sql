...
-- No customer or calendar target; reminder/follow-up paths excluded.
BEGIN;
INSERT INTO booking(booking_id,business_id,project_id,scheduled_start,scheduled_end,status,job_status,notes,assigned_to,assigned_user_id,reminder_sent,follow_up_sent,meeting_reminder_pushed_at)
SELECT 'aplive_active_' || v.variant || '_20260908',b.business_id,p.project_id,
...
AND b.notes='[KORTPROV AKTIV] ' || v.variant AND b.customer_id IS NULL
