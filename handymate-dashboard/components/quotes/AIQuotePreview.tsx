    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-primary-600/50 resize-none"
          />
        </div>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex gap-2">
            <button onClick={() => addItem('labor')} className="text-xs text-primary-600 hover:text-primary-700">+ Arbete</button>
          ...
          {items.map(item => (
            <div key={item.id} className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg">
              <span className={`px-1.5 py-0.5 text-[10px] rounded ${
                item.type === 'labor' ? 'bg-primary-100 text-primary-600' : 'bg-emerald-100 text-emerald-600'
              }`}>
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button
          ...
          className="flex-1 px-4 py-3 bg-primary-700 rounded-xl text-white font-medium hover:opacity-90 text-sm min-h-[48px]"
        >
          Använd förslaget
        </button>
      </div>
