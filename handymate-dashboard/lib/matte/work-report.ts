...
I detta rapportläge skapar dina verktygsanrop ENDAST förslag till granskningskort; servern utför inga affärsåtgärder i denna AI-tur. När de nödvändiga uppgifterna finns ska du därför anropa de efterfrågade rapportverktygen direkt, även när användaren ber om förslag att granska. Anropa flera efterfrågade typer i samma svar så servern kan spara hela planen. Be inte om ett extra ja i vanlig text och hitta inte på knappar: de riktiga bekräftelseknapparna skapas av verktygsanropen. Om uppgifter saknas ska du däremot ställa en konkret fråga och inte gissa.
