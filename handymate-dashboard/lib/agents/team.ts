...
export interface TeamAgent {
  ...
  role: string
  initials: string
  /** Tailwind-klass för fylld avatar (vit text ovanpå). */
  color: string
  /** Samma färg som hex — för prickar och inline-SVG där en klass inte går. */
  dot: string
  /** Mjuk bakgrund + text för avatarer på ljusa ytor (morgonbriefen). */
  softBg: string
  softText: string
  avatar?: string
  greeting: string
...
export const TEAM: TeamAgent[] = [
  { id: 'matte',  name: 'Matte',  role: 'Chefsagent',                initials: 'M',  color: 'bg-primary-700', dot: '#0f766e', softBg: '#E1F5EE', softText: '#0F6E56',  avatar: `${AVATAR_BASE}/Matte.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV83N2VjM2Y2OS03NThjLTQ4NDQtYTRkMi01OTUxMjE0YzlmYWYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ0ZWFtLWF2YXRhcnMvTWF0dGUucG5nIiwiaWF0IjoxNzczODU1NTkyLCJleHAiOjI2Mzc4NTU1OTJ9.jNhKpwuz1VvDTszvZ7fbczsopGCNM5c0eQHR5qq-0Ak`, greeting: 'Hej! Här är läget för idag ☀️', description: 'Koordinerar teamet och pratar med dig' },
  { id: 'karin',  name: 'Karin',  role: 'Ekonom',                   initials: 'K',  color: 'bg-blue-600', dot: '#2563eb', softBg: '#E6F1FB', softText: '#185FA5',     avatar: `${AVATAR_BASE}/Karin.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV83N2VjM2Y2OS03NThjLTQ4NDQtYTRkMi01OTUxMjE0YzlmYWYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ0ZWFtLWF2YXRhcnMvS2FyaW4ucG5nIiwiaWF0IjoxNzczODU1NjE4LCJleHAiOjI2Mzc4NTU2MTh9.bmvCwfi8Rry-5dGsJ1Zyyco--CYT6ZG3gXBPqHRiVdA`, greeting: 'Jag håller koll på ekonomin åt dig', description: 'Håller koll på fakturor och betalningar' },
  { id: 'hanna',  name: 'Hanna',  role: 'Marknadschef',             initials: 'H',  color: 'bg-purple-600', dot: '#9333ea', softBg: '#F5EAFB', softText: '#7127B5',   avatar: `${AVATAR_BASE_PUBLIC}/Hanna.png`, greeting: 'Dags att nå fler kunder!', description: 'Sköter kampanjer och nya kunder' },
  { id: 'daniel', name: 'Daniel', role: 'Säljare',                  initials: 'D',  color: 'bg-amber-600', dot: '#d97706', softBg: '#FAEEDA', softText: '#854F0B',    avatar: `${AVATAR_BASE}/Daniel.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV83N2VjM2Y2OS03NThjLTQ4NDQtYTRkMi01OTUxMjE0YzlmYWYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ0ZWFtLWF2YXRhcnMvRGFuaWVsLnBuZyIsImlhdCI6MTc3Mzg1NTY0MiwiZXhwIjoyNjM3ODU1NjQyfQ.3NE6iIAL4gje-j0warr4k6PUFqRuf7EocaDo86LZNWE`, greeting: 'Jag hjälper dig följa upp offerter', description: 'Följer upp offerter och leads' },
  { id: 'lars',   name: 'Lars',   role: 'Projektledare',            initials: 'L',  color: 'bg-emerald-600', dot: '#059669', softBg: '#E3F5EC', softText: '#05704E',  avatar: `${AVATAR_BASE}/Lars.png?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV83N2VjM2Y2OS03NThjLTQ4NDQtYTRkMi01OTUxMjE0YzlmYWYiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJ0ZWFtLWF2YXRhcnMvTGFycy5wbmciLCJpYXQiOjE3NzM4NTU2NTUsImV4cCI6MjYzNzg1NTY1NX0.mICMOQvJxG49RDXZXsc_BfKFM-AnNOscyNTL8IxPdqY`, greeting: 'Alla projekt löper på — inga förseningar', description: 'Koordinerar projekt och bokningar' },
