...
> Use the supplied Handymate portrait of Matte as a strict identity reference: man in his early thirties, short light-brown hair swept back with volume on top, close-cropped sides, short well-kept stubble, blue-grey eyes, wearing a **plain** teal hoodie with drawstrings over a dark t-shirt — **no print, no logo, no text on the chest**.

*(Lärdom 2026-08-28, första talande Matte-testet med Seedance 2.0 + Element `char_matte`: identiteten höll genom hela klippet, men modellen hittade på ett bröst­tryck med pseudotext på hoodien — kassationsgrund. Skriv alltid ut "plain … no print" uttryckligen. Elementet + porträttet som `image_references` + repliken som `audio_references` i samma generering gav läppsynk utan separat Lipsync-steg; 7 s kostade 31,7 kr.)* Photorealistic Nordic documentary commercial, vertical 9:16, natural light. **{SCEN}** Matte's performance is calm and minimal: {EN HANDLING — e.g. "he steps into frame from the left, glances at the work, then gives one short reassuring look to camera"}. He does not speak, point at the camera or gesture broadly. Realistic Swedish environment, restrained slate and natural wood, subtle teal accents only in his hoodie. No readable screens, text, logos, money, charts, robots, holograms or floating UI. Leave negative space for Swedish captions. 4 seconds, native ambience, consistent identity and wardrobe with the reference.
