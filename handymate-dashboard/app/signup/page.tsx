...
import { Zap, Loader2, ArrowRight, Check, Phone, Building2, User, Mail, Lock, Info } from 'lucide-react'
...
export default function SignupPage() {
  ...
  const formatPhoneNumber = (value: string) => {
    ...
    // Om det börjar med 0, byt till 46
    if (digits.startsWith('0')) {
      digits = '46' + digits.substring(1)
    }
    
    // Om det inte börjar med 46, lägg till det
