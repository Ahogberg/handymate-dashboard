  ...
  return (
    <div>
      <div className="relative">
        <p className="text-[13px] text-[#64748B] mb-4">Export per medarbetare och period</p>
              ...
              <div key={i} className="bg-white rounded-xl border border-[#E2E8F0] overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-6 gap-3 mb-3">
                    ...
                    {p.ob1_hours > 0 && (
                      <div className="text-center">
                        <p className="text-xs text-[#0F766E]">OB1</p>
                        <p className="text-sm font-bold text-[#0F766E]">{p.ob1_hours}h</p>
                        <p className="text-xs text-[#0D9488]">{fmtKr(p.gross_amount.ob1)}</p>
                      </div>
                    )}
                    {p.travel_km > 0 && (
                      <div className="text-center">
