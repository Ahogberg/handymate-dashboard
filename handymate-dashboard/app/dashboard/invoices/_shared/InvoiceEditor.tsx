...
export function InvoiceEditor({
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .select('quote_template_style, business_name, contact_name, contact_email, phone_number, address, org_number, f_skatt_registered, bankgiro, plusgiro, swish_number, vat_number, accent_color, logo_url, tagline, service_area')
