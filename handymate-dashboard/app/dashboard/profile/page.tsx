...
function getRoleBadge(role: string) {
  ...
  if (role === 'admin')
    return {
      label: 'Admin',
      className: 'bg-primary-100 text-primary-600 border-primary-600/30',
    }
  return {
    label: 'Anställd',
...
export default function ProfilePage() {
  ...
  return (
    <div className="relative p-4 sm:p-8 max-w-3xl mx-auto">
      ...
      <div className="pointer-events-none absolute -top-32 -left-32 w-96 h-96 bg-primary-50 rounded-full blur-3xl" />
      <div className="pointer-events-none absolute -top-16 -right-32 w-80 h-80 bg-primary-50 rounded-full blur-3xl" />
      ...
      <div className="relative bg-white rounded-xl border border-[#E2E8F0] p-6 mb-6">
        ...
        <div className="mt-6">
          <button
            onClick={handleSave}
            disabled={saving}
            className="inline-flex items-center gap-2 px-6 py-2.5 bg-primary-700 text-white font-medium rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {saving ? (
      ...
      <div className="relative bg-white rounded-xl border border-[#E2E8F0] p-6 mt-6">
        ...
        <div className="space-y-3">
            ...
            <div className="flex items-center gap-2">
              {googleStatus?.connected ? (
                ...
                <a
                  ...
                  className="flex items-center gap-1 px-3 py-1.5 text-xs bg-primary-100 text-primary-600 border border-primary-600/30 rounded-lg hover:bg-primary-700/30"
                >
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl opacity-60">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-primary-700/20">
