      ...
      <div className="relative">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
          <div className="flex items-center">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-white">AI Inbox</h1>
              <p className="text-zinc-400">Förslag från samtalsanalys</p>
            </div>
          </div>
        </div>
                                  ...
                                  <div className="min-w-0 flex-1">
                                    ...
                                    {isEditing && (
                                      <div className="mt-4 p-4 bg-zinc-900/50 rounded-xl space-y-3">
                                        <p className="text-sm text-zinc-400 mb-2">Redigera innan godkännande:</p>
