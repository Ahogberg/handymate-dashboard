                ...
                {['Metod', 'Nummer', 'Koppling', 'Verifiera'].map((label, i) => (
                  <div key={label} className="flex items-center gap-2">
                    <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold ${
                      ...
                      step === i ? 'bg-primary-700 text-white' :
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <button
                    ...
                    className="text-left p-5 bg-white rounded-xl border-2 border-gray-200 hover:border-primary-500 hover:shadow-md transition-all group"
                  >
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                {hasNumber ? (
                  <div className="mb-6">
                    ...
                    <button onClick={() => setStep(2)} className="mt-4 px-6 py-2.5 bg-primary-700 text-white rounded-lg hover:bg-primary-700 transition-colors font-medium text-sm">
                      Fortsätt
                    </button>
                  </div>
                ) : (
                    ...
                    <div className="flex gap-3 items-end">
                      <div className="flex-1">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-gray-900 focus:ring-2 focus:ring-primary-600 focus:border-primary-600"
                        />
                      </div>
                      <button
                        onClick={provisionNumber}
                        disabled={provisioning}
                        className="px-6 py-2.5 bg-primary-700 text-white rounded-lg hover:bg-primary-700 transition-colors font-medium text-sm disabled:opacity-50 flex items-center gap-2"
                      >
            ...
            {method === 'forwarding' && step === 2 && (
              <div className="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <div className="bg-gray-50 rounded-lg border border-gray-200 p-5">
                  ...
                  <ol className="space-y-3">
                    <li className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-primary-100 text-primary-700 rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">1</span>
                    ...
                    <li className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-primary-100 text-primary-700 rounded-full flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">3</span>
                ...
                <details className="mt-5 group">
                  ...
                  <div className="mt-3 bg-primary-50/50 rounded-lg border border-primary-100 p-4 text-sm text-gray-700">
                    <p className="mb-3">
                    ...
                    <div className="space-y-2 font-mono text-sm">
                      <p>
                        ...
                        <code className="bg-white border rounded px-1.5 py-0.5 text-primary-800">**61*{config?.assigned_phone_number?.replace('+', '') || 'NUMMER'}#</code>
                      </p>
                      <p>
                        <strong>Vid upptaget:</strong>{' '}
                        <code className="bg-white border rounded px-1.5 py-0.5 text-primary-800">**67*{config?.assigned_phone_number?.replace('+', '') || 'NUMMER'}#</code>
                      </p>
                      <p>
                        <strong>Båda:</strong>{' '}
                        <code className="bg-white border rounded px-1.5 py-0.5 text-primary-800">**62*{config?.assigned_phone_number?.replace('+', '') || 'NUMMER'}#</code>
                      </p>
                    </div>
                ...
                <button
                  onClick={() => setStep(3)}
                  className="mt-6 px-6 py-2.5 bg-primary-700 text-white rounded-lg hover:bg-primary-700 transition-colors font-medium text-sm"
                >
                ...
                {verifyResult ? (
                  ...
                  <div className="bg-primary-50 border border-primary-300 rounded-lg p-5 text-center">
                    ...
                    <button
                      ...
                      className="mt-3 text-sm text-primary-700 hover:text-primary-700 underline"
                    >
                      Avbryt
                    </button>
                  </div>
                  ...
                  <div className="text-center">
                    <button
                      ...
                      className="px-8 py-3 bg-primary-700 text-white rounded-lg hover:bg-primary-700 transition-colors font-medium flex items-center gap-2 mx-auto"
                    >
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className={`relative w-11 h-6 rounded-full transition-colors ${recordingEnabled ? 'bg-primary-700' : 'bg-gray-300'}`}
                  >
                ...
                {recordingEnabled && (
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 focus:ring-2 focus:ring-primary-600 focus:border-primary-600"
                  />
                )}
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    ...
                    className={`relative w-11 h-6 rounded-full transition-colors ${missedSmsEnabled ? 'bg-primary-700' : 'bg-gray-300'}`}
                  >
