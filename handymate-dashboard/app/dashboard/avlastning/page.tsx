...
export default function ReliefPage() {
  ...
  useEffect(() => {
    if (!loading && user?.is_active && window.location.hash === '#min-dag') document.getElementById('min-dag')?.scrollIntoView()
  }, [loading, user?.id, user?.is_active, business.business_id])
