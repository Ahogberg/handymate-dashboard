        ...
        <div className="prose prose-gray max-w-none space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Du når oss på <a href="mailto:privacy@handymate.se" className="text-primary-700 hover:underline">privacy@handymate.se</a>.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 mt-3">
              Kontakta oss på <a href="mailto:privacy@handymate.se" className="text-primary-700 hover:underline">privacy@handymate.se</a> eller
          ...
          <section>
            ...
            <p className="text-gray-700">
              ...
              Integritetsskyddsmyndigheten (IMY), <a href="https://www.imy.se" className="text-primary-700 hover:underline" target="_blank" rel="noopener noreferrer">www.imy.se</a>.
            </p>
          </section>
        </div>
      </div>
