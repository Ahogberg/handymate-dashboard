...
export async function POST(request: NextRequest) {
  try {
    ...
    const { critical, period, founding } = await byggAbonnemangsfalt(stripe, session)
    await writeBillingUpdate(supabase, business.business_id, critical, period, founding)
