 ...
 *
 * Steg 1 (execution-chain): logiken bor nu i lib/bookings/create-booking.ts
 * (service-role-kapabel, delas med execute.ts i Steg 3). Routen är en tunn
 * wrapper: auth → createBooking. Beteende utåt oförändrat.
 */
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await createBooking(supabase, business, body)
