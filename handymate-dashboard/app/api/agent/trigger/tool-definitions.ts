  ...
  // åt dig. Använd det ena eller det andra — aldrig båda för samma utkast.
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        job_type: { type: "string", description: "Företagets jobbtyp-slug, om känd — styr egna mallar/artiklar och bekräftade lärdomar. Gissa inte jobbtyp från en kategori." },
        template_id: { type: "string", description: "Valfritt ID för en mall som hantverkaren uttryckligen valt. Vid flera mallar returneras template_choices: fråga vilken användaren vill ha och använd det ID:t. Välj aldrig åt användaren." },
      },
