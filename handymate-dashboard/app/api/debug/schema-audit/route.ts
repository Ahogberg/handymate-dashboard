...
const EXPECTED: ExpectedColumn[] = [
  ...
  // v203 räddningskön + lanseringsbevis (kördes som v202)
  { table: 'raddningsarende', column: 'signal', migration: 'v203_raddningsko_och_lanseringsbevis', critical: false },
  { table: 'lanseringsbevis', column: 'station', migration: 'v203_raddningsko_och_lanseringsbevis', critical: false },
]
