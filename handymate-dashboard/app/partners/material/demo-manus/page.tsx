...
import { getCancellationFacts } from '@/lib/feature-gates'
    ...
    <div className="min-h-screen bg-slate-50 print:bg-white">
      <div className="max-w-3xl mx-auto px-5 py-10 print:py-0">
        ...
        <div className="text-[15px] leading-relaxed text-slate-700">
          ...
          <p className="mt-2"><strong>Säg:</strong> &rdquo;Firman kostar 5 995 kronor per månad exklusive moms vid månadsbetalning. {getCancellationFacts('monthly').short}. Hela teamet ingår, och garantin är: {getGuaranteeFacts(false).headline}. Bränsle ingår upp till planens gräns; extra påfyllning köps separat. Vi går igenom aktuella villkor tillsammans.&rdquo;</p>
