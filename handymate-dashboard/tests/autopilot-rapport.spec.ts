...
test.describe('Del 1 — cron-auth-taket och route-auth-inventeringen', () => {
  ...
  test('facit-route-auth-inventory har höjt eller behållit taket för utan-standardgrind', () => {
    ...
    // Taket steg till 153 med yta 9 (publik demo-offert, 2026-09-08); regexen
    // följer: höjt eller behållet, aldrig sänkt under 144.
    expect(inv).toMatch(/toBeLessThanOrEqual\(1(4[4-9]|5[0-9])\)/)
  })
})
